...
import Modelo.FuncionesTipoCliente;
 ...
 * @author samue
 */
public class PanelTipoCliente extends javax.swing.JFrame {

    CostructorTipoCliente tc = new CostructorTipoCliente();
    FuncionesTipoCliente ct = new FuncionesTipoCliente();
    Connection con2;
    Statement orden;
    ResultSet rs;
        ...
        public void TablaTipo()
  {
    ...
    { 
       ...
       rs = orden.executeQuery("Select * From TipoCliente");
       while(rs.next())
       {
           Object Filas[] = {rs.getString(1), rs.getString(2) };
           md.addRow(Filas);
       }
       listTipoCliente.setModel(md);
    }
    catch(Exception ex)
    {
    ...
    private void initComponents() {
        ...
        listTipoCliente = new javax.swing.JTable();
        ...
        jLabel2.setText("Administración de Tipo de Cliente");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, -1, -1));

        jScrollPane2.setBackground(new java.awt.Color(204, 204, 204));
        jScrollPane2.setForeground(new java.awt.Color(255, 255, 255));

        listTipoCliente.setBackground(new java.awt.Color(204, 204, 204));
        listTipoCliente.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        listTipoCliente.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listTipoClienteMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(listTipoCliente);
        ...
        txtTipoCliente.setBackground(new java.awt.Color(33, 33, 33));
        txtTipoCliente.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        ...
        jPanel1.add(txtTipoCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 200, 35));
    ...
    private void btnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAgregarActionPerformed
        ...
        int id=ct.idIncremental();
        
        tc.setId(id);
        tc.setTipo(txtTipoCliente.getText());
        if(ct.guardarTipoCliente(tc))
     {
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        {
         tc.setId(Integer.parseInt(txtCodigo.getText()));
       if(ct.consultarTipo(tc))
       {
         txtTipoCliente.setText(tc.getTipo());
         TablaTipo();  
       }
       else
        {
    ...
    private void listTipoClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listTipoClienteMouseClicked
       
       int fila=listTipoCliente.getSelectedRow();
       txtCodigo.setText(String.valueOf(listTipoCliente.getValueAt(fila,0)));
       txtTipoCliente.setText(String.valueOf(listTipoCliente.getValueAt(fila,1)));
        
    }//GEN-LAST:event_listTipoClienteMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelTipoCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelTipoCliente().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable listTipoCliente;
