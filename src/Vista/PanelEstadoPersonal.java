 ...
 * @author samue
 */
public class PanelEstadoPersonal extends javax.swing.JFrame {
    ...
    /**
     * Creates new form PanelEstadoPersonal
     */
    public PanelEstadoPersonal() {
        initComponents();
    ...
    FuncionesEstadoPersona mensa = new FuncionesEstadoPersona();
    ConstructorEstadoPersona obj = new ConstructorEstadoPersona();
    
    public void prTabla() {
        String titulos[] = {"Codigo", "Estado Personal"};
        DefaultTableModel tm = new DefaultTableModel(null, titulos);
        try {
            orden = con2.createStatement();
            rs = orden.executeQuery("SELECT * FROM EstadoPersona");
            ...
            listEstadoUsuario.setModel(tm);
            
        } catch (SQLException ex) {
            Logger.getLogger(PanelEstadoPersonal.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void initComponents() {
        ...
        listEstadoUsuario = new javax.swing.JTable();
        ...
        jLabel2.setText("Administración de Estado de Personal");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, -1, -1));

        jScrollPane2.setBackground(new java.awt.Color(204, 204, 204));
        jScrollPane2.setForeground(new java.awt.Color(255, 255, 255));

        listEstadoUsuario.setBackground(new java.awt.Color(204, 204, 204));
        listEstadoUsuario.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        listEstadoUsuario.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                listEstadoUsuarioMouseClicked(evt);
            }
        });
        jScrollPane2.setViewportView(listEstadoUsuario);

        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 670, 270));

        jLabel13.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("ESTADO USUARIO:");
        ...
        txtEstadoUsuario.setBackground(new java.awt.Color(33, 33, 33));
        txtEstadoUsuario.setFont(new java.awt.Font("Yu Gothic UI", 0, 18)); // NOI18N
        txtEstadoUsuario.setForeground(new java.awt.Color(255, 255, 255));
        txtEstadoUsuario.setBorder(null);
        txtEstadoUsuario.setCaretColor(new java.awt.Color(255, 255, 255));
        jPanel1.add(txtEstadoUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 170, 200, 35));
    ...
    public void agregarEstadoPerso() {
        if (txtEstadoUsuario.getText().trim().equals("")) {
            ...
            obj.setId(ids);
            obj.setEstado(txtEstadoUsuario.getText());
            
            if (mensa.agregarEstadoPersona(obj)) {
    ...
    public void actualizarEstadoPerso() {
        if (txtEstadoUsuario.getText().trim().equals("")) {
            ...
            if (mensa.actualizarEstadoPersona(obj)) {
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        actualizarEstadoPerso();
    }//GEN-LAST:event_btnActualizarActionPerformed
    
    public void mostrarEstadoPerso() {
        if (txtBusqueda.getText().trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "El campo Busqueda esta vacio, por favor rellenelo", "Campo Vacío", JOptionPane.WARNING_MESSAGE);
            
        } else {
            obj.setId(Integer.parseInt(txtBusqueda.getText()));
            if (mensa.mostrarEstadoPersona(obj)) {
                txtCodigo.setText(String.valueOf(obj.getId()));
                txtEstadoUsuario.setText(obj.getEstado());
                prTabla();
    ...
    private void listEstadoUsuarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listEstadoUsuarioMouseClicked
        int seleccion = listEstadoUsuario.getSelectedRow();
        
        txtCodigo.setText(String.valueOf(listEstadoUsuario.getValueAt(seleccion, 0)));
        txtEstadoUsuario.setText(String.valueOf(listEstadoUsuario.getValueAt(seleccion, 1)));
        btnActualizar.setEnabled(true);
        btnAgregar.setEnabled(false);

    }//GEN-LAST:event_listEstadoUsuarioMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PanelEstadoPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PanelEstadoPersonal().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable listEstadoUsuario;
